...
+ 如果文件过多，启动或者生成文件的时候有点慢

# 小提示
有些小伙伴说npm install 会有些失败，可能是因为一些包失效的缘故吧，这样，我这次提交更新所有依赖的npm包，然后大家下载到本地之后直接解压到当前文件夹，记住是当前文件夹的，然后不用npm install就可以直接npm start跑起来项目了。

# 最后
如果小伙伴们想要更多的交流，可以加一下我创建的react群，598372207

我上面提到的一些问题，如果有哪位小伙伴比较有兴趣跟我一起维护这个框架的话，请联系我，这个项目我拷贝出来一份去进行多人维护的，希望咱们可以把这个框架做得越来越好